...
UBTDecorator_AttackInMiddleRange::UBTDecorator_AttackInMiddleRange()
{
	NodeName = TEXT("CanMiddleAttack");
}

bool UBTDecorator_AttackInMiddleRange::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
